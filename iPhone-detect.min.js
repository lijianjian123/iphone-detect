function getRenderer(n, t) {
  function u() {
    ...
    var n,
      ...
      r = {
        create: function() {
          for (var t = new Array(16), n = 0; n < 16; n++)
            t[n] = n % 5 == 0 ? 1 : 0;
          return t;
        },
    ...
    function f(n, t, f) {
      ...
      try {
        ...
        for (e = 0; e < o.length; e++)
          h.active++,
            o[e].postMessage(80),
            (o[e].timeout = setTimeout(r, 4e3, o[e]));
      } catch (c) {
        t(new Error(c));
      }
    }
  ...
  var l = [
      ...
      {
        x:
          "Apple A7 GPU|Apple A8 GPU|Apple A9 GPU|Apple A10 GPU|Apple A11 GPU|Apple A12 GPU|Apple A13 GPU",
        m: function(n) {
          return h(n);
        },
        n: [9, 10, 11, 5, 6, 7, 8, 4],
      ...
      {
        x:
          "Apple A7 GPU|Apple A8 GPU|Apple A9X GPU|Apple A10X GPU|Apple A9 GPU|Apple A12X GPU|Apple A10 GPU|Apple A12 GPU|Apple A8X GPU",
        m: function(n) {
          return h(n);
        },
        n: [16, 15, 14, 13, 12],
      ...
      {
        x:
          "Apple A9X GPU|Apple A10X GPU|Apple A9 GPU|Apple A10 GPU|Apple A11 GPU|Apple A12X GPU|Apple A12 GPU|Apple A8 GPU|Apple A8X GPU|Apple A13 GPU",
        m: function(n) {
          return h(n);
        },
      ...
      {
        x:
          "Apple A9X GPU|Apple A10X GPU|Apple A9 GPU|Apple A12X GPU|Apple A10 GPU|Apple A12 GPU|Apple A8 GPU|Apple A8X GPU",
        m: function(n) {
          return r(n);
        },
        n: [33, 38],
      ...
      {
        x:
          "Apple A7 GPU|Apple A8 GPU|Apple A9X GPU|Apple A9 GPU|Apple A10 GPU|Apple A8X GPU",
        m: function(n) {
          return i(n);
        },
      ...
      {
        x:
          "Apple A9X GPU|Apple A9 GPU|Apple A10 GPU|Apple A8 GPU|Apple A8X GPU",
        m: function(n) {
          return i(n);
        },
        n: [55, 65, 63, 64, 53, 54],
